# Q1.4 code part 2 (plot generation)
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load("../model_checkpoints/Q1/vgg11_aug.pt"))
    model.eval()
    ...
    plt.title('Q1.4: Test Accuracy vs. Flip Type')
    plt.savefig("../plots/Q1_4E.png")
    plt.show()
    
    plt.bar(['0.01', '0.1', '1'], [accuracy3, accuracy4, accuracy5], color ='rebeccapurple', width = 0.4)
    plt.ylabel('Test Accuracy')
    plt.xlabel('Variance of Noise')
    plt.title('Q1.4: Test Accuracy vs. Variance of Noise')
    plt.savefig("../plots/Q1_4F.png")
    plt.show()
