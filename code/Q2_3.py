...
if __name__ == '__main__':
    ...
    # Save output
    torch.save(model.state_dict(), f"../model_checkpoints/Q2/Q2.3_GIN.pt")
    ...
    with open("../plots/Q2_3_res.json", "w") as write_file:
    ...
    plt.title("Q2.3 Training Loss, Train and Test Accuracy per iteration")
    plt.show()
